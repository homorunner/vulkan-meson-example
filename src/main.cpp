...
private:
    ...
    static void scrollCallback(GLFWwindow* window, double xoffset, double yoffset) {
        auto app = reinterpret_cast<HelloTriangleApplication*>(glfwGetWindowUserPointer(window));
        app->scroll_x_offset += xoffset;
        app->scroll_y_offset += yoffset;
    }

    static void cursorPositionCallback(GLFWwindow* window, double xpos, double ypos) {
        auto app = reinterpret_cast<HelloTriangleApplication*>(glfwGetWindowUserPointer(window));
        app->mouse_x_pos = xpos;
        app->mouse_y_pos = ypos;
    }
    ...
    void createGraphicsPipeline() {
        ...
        pipelineLayoutInfo.pPushConstantRanges = new VkPushConstantRange{
    ...
    void recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex) {
        ...
        ImGui::Begin("fps_window", nullptr,
        ...
        auto elapsed_seconds =
            std::chrono::duration_cast<std::chrono::milliseconds>(now - begin).count() / 1000.0;
        ShaderInput input = {(float)swapChainExtent.width, (float)swapChainExtent.height,
                             mouse_x_pos / (float)swapChainExtent.width,
                             mouse_y_pos / (float)swapChainExtent.height, (float)elapsed_seconds};
